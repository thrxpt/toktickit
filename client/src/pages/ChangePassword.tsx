  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(
          errorData.error?.message || 'Failed to change password. Please try again.',
        )
      }
      ...
      <div className="card shadow-sm w-100" style={{ maxWidth: '480px' }}>
        <div className="card-body p-4 p-sm-5">
          ...
          <div className="text-center mb-4">
            <h1 className="h3 fw-bold mb-2" style={{ color: 'var(--zen-primary)' }}>
          ...
          <form onSubmit={handleSubmit} noValidate>
              ...
              <ul className="list-unstyled mb-0 small">
                <li
                  className={`d-flex align-items-center mb-1 ${
                    hasMinLength ? 'text-success fw-medium' : 'text-body-secondary'
                  }`}
                ...
                <li
                  className={`d-flex align-items-center mb-1 ${
                    hasUppercase ? 'text-success fw-medium' : 'text-body-secondary'
                  }`}
                ...
                <li
                  className={`d-flex align-items-center mb-1 ${
                    hasLowercase ? 'text-success fw-medium' : 'text-body-secondary'
                  }`}
                ...
                <li
                  className={`d-flex align-items-center mb-1 ${
                    hasSpecialChar ? 'text-success fw-medium' : 'text-body-secondary'
                  }`}
                ...
                {newPassword.length > 0 && currentPassword.length > 0 && !isDifferentFromCurrent && (
            ...
            {confirmPassword.length > 0 && (
              <div className="mb-3 small">
                {passwordsMatch ? (
                  <span className="text-success fw-medium" data-testid="password-match">
                    ✓ Passwords match
                  </span>
                ) : (

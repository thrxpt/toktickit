...
- **AC-42** Given any screen at 1440 px, 800 px, and 390 px, when it renders, then no horizontal page scrolling occurs and no label, message, or button is clipped or hidden.
- **AC-43** Given My Tickets at 390 px, when it renders, then Tickets appear as cards rather than a horizontally scrolling table.
